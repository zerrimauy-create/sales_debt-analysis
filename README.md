...
![Дни недели 2024](diagram2024.png)
...
1. Положите файл `report.txt` в корень проекта.
2. Скомпилируйте и запустите нужный Java-скрипт (Java 17+).
3. CSV-файлы сохранятся автоматически.
